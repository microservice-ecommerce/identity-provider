export class DatabaseColumn {
  ...
  public static readonly CONFIRMATION_TOKEN = 'str_confirmation_token';

  public static readonly TOKEN_GENERATION_TIME = 'dt_token_generation_time';

  public static readonly STATUS_DESCRIPTION = 'str_status_description';
}
